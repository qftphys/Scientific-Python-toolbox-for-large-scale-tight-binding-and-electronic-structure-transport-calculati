# -*- coding: utf-8 -*-
#
# sids documentation build configuration file, created by
...
from sids_info import version, release
...
exclude_patterns = ['sids/**/setup.py','**/tests']
...
from sids_info import html_theme
...
latex_documents = [
  (master_doc, 'sids.tex', u'sids Documentation',
...
man_pages = [
    (master_doc, 'sids', u'sids Documentation',
     [author], 1)
]
