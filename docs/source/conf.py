...
# Import sisl_info
# Extend path, to ensure that it is the correct sisl_info that we
# grab
sys.path.insert(0, os.path.dirname(__file__) )
from sisl_info import version, release
...
exclude_patterns = ['sisl/**/setup.py','**/tests']
...
from sisl_info import html_theme
